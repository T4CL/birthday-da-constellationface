...
const dogImg = new Image(); dogImg.src = "/pibble.png";
const bgImg = new Image(); bgImg.src = "/backgroundd.jpeg";
...
document.getElementById("start-btn").addEventListener("click", () => {
    ...
    playerSprite.src = "/pngcorrendo.gif";
